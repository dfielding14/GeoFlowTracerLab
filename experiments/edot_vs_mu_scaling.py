...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    for a in alphas:
        ...
        for pe in peclets:
            ...
            # Plot structure functions with fits and slopes
            ...
            fig, (ax_top, ax_bot) = plt.subplots(2, 1, figsize=(7.6, 6.4), dpi=160, sharex=True, constrained_layout=True, gridspec_kw={"height_ratios":[2.4,1.0], "hspace":0.05})
